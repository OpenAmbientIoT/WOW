...
class ClientMQTT {
    ...
    constructor() {
        this.connection = {
            host: 'stage.wiliot.services',// 'stage.wiliot.services', //+
            port: 9001, // +
            endpoint: '/mqtt',
            clean: true,
            connectTimeout: 4000,
            ...
            username: 'wiliot.cloud',
            password: 'rzcMsAv4oT0VkFkL1wfTaqLsX2zPVP+eYOGDvJEKSdNBRPsS',
        }
        this.subscription = {
            topic: 'wiliot.cloud/pixel/id',
            qos: 0,
        }
        this.publish = {
            topic: 'wiliot.cloud/pixel/id',
